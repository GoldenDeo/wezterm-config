...
| Keys                              | Action                  |
| --------------------------------- | ----------------------- |
| <kbd>SUPER_REV</kbd>+<kbd>w</kbd> | Move to Pane (Up)       |
| <kbd>SUPER_REV</kbd>+<kbd>s</kbd> | Move to Pane (Down)     |
| <kbd>SUPER_REV</kbd>+<kbd>a</kbd> | Move to Pane (Left)     |
| <kbd>SUPER_REV</kbd>+<kbd>e</kbd> | Move to Pane (Right)    |
