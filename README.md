...
| Keys                              | Action                  |
| --------------------------------- | ----------------------- |
| <kbd>SUPER_REV</kbd>+<kbd>↑</kbd> | Move to Pane (Up)       |
| <kbd>SUPER_REV</kbd>+<kbd>↓</kbd> | Move to Pane (Down)     |
| <kbd>SUPER_REV</kbd>+<kbd>←</kbd> | Move to Pane (Left)     |
| <kbd>SUPER_REV</kbd>+<kbd>→</kbd> | Move to Pane (Right)    |
